...
<header>
	<img src="/static/images/banner4.jpg" alt="" width="100%">
</header>
			...
			<div class="col-sm-4" style="padding-right: 15px;">
				<div class="input-group">
					<form action="/product/list-by-keywords" method="post">
						<input style="width: 80%" class="form-control" value="${param.keywords}" name="keywords" placeholder="Tìm kiếm" />
								...
								<div class="card-sp">
									<ul>
										<li>
											...
											<p class="carts"><a href="/cart/view" style="text-decoration: none; color: #474c51"><span class="cart-text">Giỏ hàng</span></a></p>
											<ul>
												<li>
													<div class="row">
														<c:choose>
					...
					<div class="col-sm-6">
						<div class="header-menu">
							<i class="glyphicon glyphicon-heart" style="font-size: 30px; padding: 0px 5px 0px 5x"></i> 
								<a class="splike" href="/product/favo" style="color: #474c51"><span class="cart-text">Sản phẩm đã thích </span></a>
						</div>
					</div>
				</div>
			</div>
