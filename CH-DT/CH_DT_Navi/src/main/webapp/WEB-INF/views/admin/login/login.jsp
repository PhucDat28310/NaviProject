...
<div class="limiter">
	<div class="container-login100">
		<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
			<form class="login100-form validate-form" action="/admin/login"
				method="post">
				<span class="login100-form-title p-b-33"> <b>ĐĂNG NHẬP</b>
				</span>
				<h8 style="color: red;padding:0px 0px 0px 20px">${message}</h8>
				<br /> <br />
				<div class="wrap-input100 validate-input">

					<input class="input100" type="text" name="id" value="${uid}"
				...
				<div class="wrap-input100 rs1 validate-input"
					...
					<input class="input100" type="password" name="pw" value="${pwd}"
						placeholder="Mật khẩu"> <span class="focus-input100-1"></span>
...
.container-login100 {
	background-image: linear-gradient(0, #e9faff, #73d3ef)
}
</style>